    ...
    <div className="flex flex-col  w-full   my-44  justify-start bg-custom-gray border-2 rounded-[34px] shadow-2xl">
      ...
      <div className="px-5 py-6">
        ...
        <div className="flex justify-between items-center mt-4">
          <button className="px-8 py-2 rounded-[10px] bg-slate-200 text-slate-800">
            جزییات دوره
          </button>

          <button className="px-8 py-2 rounded-[10px] bg-darkGreen text-slate-800">
            رزرو دوره
          </button>
        </div>
      </div>
